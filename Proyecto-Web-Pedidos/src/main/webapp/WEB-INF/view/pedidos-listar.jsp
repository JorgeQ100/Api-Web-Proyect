						...
						<tr>
							...
							<td>
								<button class="btn btn-success"
								 onclick="window.location.href='/Proyecto-Web-Pedidos/pedidos/findOne?idPedidos=${items.idPedidos}&opcion=1'; return false;">
									Actualizar
								</button>
								<br>
								<button class="btn btn-danger"
								onclick="window.location.href='/Proyecto-Web-Pedidos/pedidos/findOne?idPedidos=${items.idPedidos}&opcion=2'; return false;">
									Eliminar
								</button>
							</td>
						</tr>
